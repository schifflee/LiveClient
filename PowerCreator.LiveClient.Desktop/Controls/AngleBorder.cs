using PowerCreator.LiveClient.Infrastructure.Double;
using System;
using System.Windows;
using System.Windows.Controls;
using System.Windows.Media;

namespace PowerCreator.LiveClient.Desktop.Controls
{
    public sealed class AngleBorder : Decorator
    {
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            if (Child != null)
            {
                ...
                pen.Thickness = AngleBorder.RoundLayoutValue(BorderThickness.Left, DoubleUntility.DpiScaleX);
